...
## 使用说明  只需要看这个就行！！！！！
1.将clone下来的文件中的demo丢入小程序uniapp中打开；
2.复制colorui中的两个文件到需要引用样式的小程序根目录即可：icon.wxss   main.wxss
3.在小程序app.wxss中，引用上面2个文件 格式：@import 'main.wxss'
4.查看元素打开，将需要引用的模板，找到class直接复制即可，缺少的功能自己去js里面找
## 前言
